...
const ProductSelfDev = () => {
    const url = 'http://localhost:2005'

    const [books, setBooks] = useState([])
  
      const fetchSelfDevBooks = async()=>{
        const books = await axios.get(`${url}/books/3`)
  ...
  return (
    <>
    <h1>Self Development Books Page</h1>
